...
(
    work_id INT(11) PRIMARY KEY,
    work_type VARCHAR(24) NOT NULL,
    work_title VARCHAR(48) NOT NULL,
    work_year DATE NOT NULL,
    work_width INT(11) NOT NULL,
    work_height INT(11) NOT NULL,
    work_lenght INT(11) NOT NULL,
    work_copy_owned INT(11) NULL UNIQUE
);

CREATE TABLE IF NOT EXISTS museums
(
    museum_id INT(11) PRIMARY KEY,
