...
Exercice 1.1.1 : Calcul de la moyenne de 2 nombres  
Exercice 1.2 : Calcul de l’aire et du volume d’une sphère <=> with try catch and fonction  
Exercice 1.3 : Calcul de la surface d’un secteur circulaire  
Exercice 1.4 : Inversion de 2 valeurs <=> with try catch and fonction  
Exercice 1.5 : Calcul d’intérêts  
Exercice 1.6 : Nombre Premier  
Exercice 1.7 : Tri de nombres    
Exercice 1.8 : Année Bissextile <=> with try catch  
